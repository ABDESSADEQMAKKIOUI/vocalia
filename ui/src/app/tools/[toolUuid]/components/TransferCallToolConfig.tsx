                    ...
                    >
                        ...
                        <TabsContent value="dynamic" className="space-y-5 mt-4">
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Volira sends the resolved argument dictionary to this endpoint. The endpoint must return transfer_context.destination and may return transfer_context.custom_message.
                                </p>
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                />
                                <Label className="text-xs text-muted-foreground">
                                    Volira sends a POST request with the resolved argument dictionary.
                                </Label>
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                />
                                <Label className="text-xs text-muted-foreground">
                                    Spoken while Volira waits for the resolver response.
                                </Label>
                            </div>
                            ...
                            <div className="grid gap-2 pt-4 border-t">
                                ...
                                <Label className="text-xs text-muted-foreground">
                                    Add values Volira injects at runtime. These are not exposed to the LLM and can use templates like {`{{initial_context.state}}`} or {`{{gathered_context.state}}`}.
                                </Label>
                                <PresetParameterEditor
